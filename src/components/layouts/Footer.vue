          ...
          <div class="category">
            <RouterLink to="/">
              <img
                ...
                alt="logo"
                class="h-8 drop-shadow-lg"
              />
            </RouterLink>
            <p
              class="mt-4 text-sm font-normal leading-6 text-left text-slate-400"
            >
          ...
          <div class="category basis-4/12">
            ...
            <ul class="flex flex-col gap-3 mt-2 text-left">
              <li>
                <a
                  href="/"
                  class="text-sm font-light text-slate-500 hover:text-amber-600"
                  >Beranda</a
                >
              </li>
              <li>
            ...
            <ul class="flex flex-col gap-3 mt-2 text-left">
              <li>
                <div class="flex flex-row gap-2 title">
                  ...
                  <a
                    href="/"
                    class="text-sm font-light text-slate-800 hover:text-amber-600"
                    >Email</a
                  >
                </div>
